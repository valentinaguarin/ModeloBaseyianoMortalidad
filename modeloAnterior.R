...
x2 = (Age...27 - mean(Age...27))/sd(Age...27)
x3 = (OsSats-mean(OsSats))/sd(OsSats)
x4 = (CrctProtein - mean(CrctProtein))/sd(CrctProtein)
x5 = (Procalcitonin - mean(Procalcitonin))/sd(Procalcitonin)
x6 = severidad_grupos
...
bayes.mod.inits <- function(){
  list("b" = rnorm(7))  #cantidad de variables 
}
